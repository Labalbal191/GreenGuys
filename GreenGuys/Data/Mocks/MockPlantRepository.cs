            ...
            get
            {
                return new List<Plant>
                {
                    ...
                    new Plant
                    {
                        ...
                        Category = _categoryRepository.Categories.First(),
                        ImageURL = "https://desenio.pl/bilder/artiklar/zoom/12746_2.jpg?imgwidth=435&qt=Kaktus%20na%20tle%20r%C3%B3zowej%20sciany",
                        ImageThumbnailURL = "https://desenio.pl/bilder/artiklar/zoom/12746_2.jpg?imgwidth=435&qt=Kaktus%20na%20tle%20r%C3%B3zowej%20sciany",
                        InStock = true,
                        IsMostPopular = true,
                    },
                    new Plant
                    {
                        ...
                        Category = _categoryRepository.Categories.First(),
                        ImageURL = "https://zielony-parapet.pl/4101-thickbox_default/aloe-vera-aloes-leczniczy.jpg",
                        ImageThumbnailURL = "https://zielony-parapet.pl/4101-thickbox_default/aloe-vera-aloes-leczniczy.jpg",
                        InStock = true,
                        IsMostPopular = true,
                    },
                    new Plant
                    {
                        ...
                        ImageURL = "https://www.houseplantsexpert.com/image-files/venus-fly-trap.jpg",
                        ImageThumbnailURL = "https://www.houseplantsexpert.com/image-files/venus-fly-trap.jpg",
                        InStock = true,
                        IsMostPopular = false,
                    }
